...
[
  {
    "id": 1,
    "title": "우선 출생정보를 입력하세요",
    "detail": {
      "title": "우선 출생정보를 입력하세요",
      "description": "아이의 성과 생년월일 등의 기본 정보를 입력하세요. 복성은 성의 음을 한글 (예: 남궁)로 입력 한 후 한자 선택은 복성의 첫 번째 한자 (예: 南)를 선택하면 됩니다. 출생지역은 인근 도시의 위도와 경도를 이용하여 설정할 수 있습니다. 태어난 시간은 썸머타임이 아닌 원래의 시간을 사용합니다.",
      "image": "headsup_image",
