...
[
  ...
  },
 {
    ...
    "detail": {
      "title": "셀프작명",
      "description": "셀프 작명 메뉴로 이름을 작명하세요. 셀프작명은 원하는 한글 이름을 이용하여 사주에 적합한 한자 이름을 조합해 줍니다. 추천 작명은 요즘 인기있는 한글 이름 중에서 사주에 적합한 한자 이름 조합을 제공합니다. 이름 작성 중 마음에 드는 이름이 있으면 저장 메뉴를 선택하여 저장하고, 저장목록 메뉴를 선택하여 확인할 수 있습니다. 대법원 인명 용 한자중에서 일반적으로 사용되는 6000자를 이용하였습니다. 한글 이름의 표준 영어 표기와 발음을 제공합니다. 영문이름을 지을 경우 활용하시면 됩니다.",
