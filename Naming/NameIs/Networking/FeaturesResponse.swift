...
[
  ...
  },
 {
  ...
  },
  {
    ...
    "detail": {
      "title": "발음오행은 참고로 사용하세요",
      "description": "한글의 자음 소리에 따라서 오행 (木, 火, 土, 金, 水)으로 분류할 수 있습니다. 예를 들면 'ㄱ'과 'ㅋ'은 木, 'ㅅ'과 'ㅈ'은 金이 됩니다. 쉬운작명 에서는 음양과 자원오행을 기준으로 작명을 하되, 발음오행은 참고로 사용합니다. 발음이 중요하기는 하나, 순수 한글 이름이 아닌 이상 글자의 뜻 이 더 중요하다는 것이 저자의 견해입니다. 하지만 만약 자원오행을 기준으로 만족할만한 이름을 찾을 수 없다면 발음오행을 고려해 볼 수 있다고 봅니다.",
      "image": "asset_image",
      "link": "featuresApp://hackathon.com/assets"
    }
  },
  {
    ...
    "detail": {
      "title": "고려하지 않은 작명 이론들",
      "description": "수리오행, 81수리, 그리고 삼원오행 등은 근거가 없는 것으로 알려져 있으며, 오히려 나쁜 이름을 좋은 이름으로 만들 수 있어서 여기에서는 고려하지 않도록 하였습니다.",
      "image": "asset_image",
      "link": "featuresApp://hackathon.com/assets"
    }
  },
